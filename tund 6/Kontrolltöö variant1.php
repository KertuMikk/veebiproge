...
/*$LanguageHTML = "";
	...
	if (isset ($_POST["keel"]) and isset ($_POST["jaanuar"]) and isset ($_POST["veebruar"]) and isset ($_POST["märts"]) and isset ($_POST["aprill"]) and isset ($_POST["mai"]) and isset ($_POST["juuni"]) and isset ($_POST["juuli"]) and isset ($_POST["august"]) and isset ($_POST["september"]) and isset ($_POST["oktoober"]) and isset ($_POST["november"]) and isset ($_POST["detsember"]) and isset ($_POST["firstname"]) and isset ($_POST["lastname"]) and !empty ($_POST["keel"]) and !empty ($_POST["jaanuar"]) and !empty ($_POST["veebruar"]) and !empty ($_POST["märts"]) and !empty ($_POST["aprill"]) and !empty ($_POST["mai"]) and !empty ($_POST["juuni"]) and !empty ($_POST["juuli"]) and !empty ($_POST["august"]) and !empty ($_POST["september"]) and !empty ($_POST["oktoober"]) and !empty ($_POST["november"]) and !empty ($_POST["detsember"]) and !empty ($_POST["firstname"]) and !empty ($_POST["lastname"]))
	{

		$notice = Lisa(($_POST["firstname"]) , ($_POST["lastname"]) , ($_POST["keel"]) , ($_POST["jaanuar"]) , ($_POST["veebruar"]) , ($_POST["märts"]) , ($_POST["aprill"]),($_POST["mai"]), ($_POST["juuni"]) , ($_POST["juuli"]) , ($_POST["august"]) , ($_POST["september"]) , ($_POST["oktoober"]) , ($_POST["november"]), ($_POST["detsember"]));
...
<form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" action="/Kontrolltöö variant.php">
